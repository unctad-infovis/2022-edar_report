      ...
      <div className="chapter_navigation">
        ...
        <button className="chapter_selection" type="button" onClick={() => anchorClick(2)}>
          <div className="description">
            ...
            <p>Firms can facilitate high-value-added export diversification in Africa, especially through the services sector, when supported by sound financial services or provided with access to affordable financing.</p>
          </div>
        </button>
      </div>
